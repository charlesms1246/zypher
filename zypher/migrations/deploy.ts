...
module.exports = async function (provider) {
  ...
  const program = anchor.workspace.ZypherProtocol;
  const wallet = provider.wallet;

  console.log("🚀 Starting Zypher Protocol deployment...");
  ...
  try {
    ...
    console.log("✅ AEGIS Mint:", zypherMint.toString());
    ...
    try {
      ...
      console.log("   AEGIS Mint:", config.zypherMint.toString());
    ...
    console.log("   2. Users can mint AEGIS via mint_zypher instruction");
    ...
    console.log(`   spl-token accounts ${zypherMint.toString()}`);
    ...
    const deploymentInfo = {
      ...
      zypherMint: zypherMint.toString(),
